							...
							<div class="form_center">
								<form class="form-horizontal" action="" method="post">
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" class="form-control" name="role_name" id="" placeholder="角色名称">
										</div>
									</div>
									<div class="form-group">
										<label for="inputEmail3" class="col-sm-2 control-label">是否启用</label>
										<div class="col-sm-10">
											<input type="radio"  name="role_status" value="1" checked>启用
											<input type="radio"  name="role_status"  value="0">禁用
										</div>
									</div>
										...
										<div class="col-sm-10">
											<table class="table table-bordered">
												@foreach($nodeTree as $key=>$val)
													<tr >
														<td ><input type="checkbox" class="parent" name="node_id[]"  value="{{$val->node_id}}">{{$val->node_name}}</td>
														<td >
															@foreach($val->son as $k=>$v)
																<input  type="checkbox" class="son" name="node_id[]"  value="{{$v->node_id}}">{{$v->node_name}}
															@endforeach
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<textarea name="role_desc" cols="40" rows="10"></textarea>
										</div>
									</div>
									<div class="form-group">
